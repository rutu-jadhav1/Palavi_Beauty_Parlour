function star(n)
{
    ...
    for( let i=0; i<n; i++)
        {
        if(n==1){
            star1.src = './../logo/star2.png';
            star2.src = './../logo/star1.png';
            star3.src = './../logo/star1.png';
            star4.src = './../logo/star1.png';
            star5.src = './../logo/star1.png';
        }
        else if(n==2){
            star1.src = './../logo/star2.png';
            star2.src = './../logo/star2.png';
            star3.src = './../logo/star1.png';
            star4.src = './../logo/star1.png';
            star5.src = './../logo/star1.png';
        }
